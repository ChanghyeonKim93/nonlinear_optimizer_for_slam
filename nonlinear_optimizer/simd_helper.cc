...
// void PointWarper::Warp(const std::vector<Eigen::Vector3f>& points,
...
//         _SIMD_ADD_PS(
//             _SIMD_ADD_PS(_SIMD_MUL_PS(_r11, _x), _SIMD_MUL_PS(_r12, _y)),
//             _SIMD_MUL_PS(_r13, _z)),
//         _t1);
//     _SIMD_TYPE _y_warp = _SIMD_ADD_PS(
//         _SIMD_ADD_PS(
//             _SIMD_ADD_PS(_SIMD_MUL_PS(_r21, _x), _SIMD_MUL_PS(_r22, _y)),
//             _SIMD_MUL_PS(_r23, _z)),
//         _t2);
//     _SIMD_TYPE _z_warp = _SIMD_ADD_PS(
//         _SIMD_ADD_PS(
//             _SIMD_ADD_PS(_SIMD_MUL_PS(_r31, _x), _SIMD_MUL_PS(_r32, _y)),
//             _SIMD_MUL_PS(_r33, _z)),
//         _t3);

//     _x_warp =
//         _SIMD_ADD_PS(_SIMD_ADD_PS(_SIMD_ADD_PS(_SIMD_MUL_PS(_r11, _x_warp),
//                                                _SIMD_MUL_PS(_r12, _y_warp)),
//                                   _SIMD_MUL_PS(_r13, _z_warp)),
//                      _t1);
//     _y_warp =
//         _SIMD_ADD_PS(_SIMD_ADD_PS(_SIMD_ADD_PS(_SIMD_MUL_PS(_r21, _x_warp),
//                                                _SIMD_MUL_PS(_r22, _y_warp)),
//                                   _SIMD_MUL_PS(_r23, _z_warp)),
//                      _t2);
//     _z_warp =
//         _SIMD_ADD_PS(_SIMD_ADD_PS(_SIMD_ADD_PS(_SIMD_MUL_PS(_r31, _x_warp),
//                                                _SIMD_MUL_PS(_r32, _y_warp)),
