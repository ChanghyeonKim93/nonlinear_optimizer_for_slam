...
bool MahalanobisDistanceMinimizerAnalyticSIMD::SolveUsingHelperFloat(
    const std::vector<Correspondence>& correspondences, Pose* pose) {
...
bool MahalanobisDistanceMinimizerAnalyticSIMD::SolveFloat_FAST1(
    const std::vector<Correspondence>& correspondences, Pose* pose) {
  using Vec3f = Eigen::Vector3f;
  using Mat3x3f = Eigen::Matrix3f;
  using Orientationf = Eigen::Quaternionf;
...
bool MahalanobisDistanceMinimizerAnalyticSIMD::SolveFloat_FAST2(
    const std::vector<Correspondence>& correspondences, Pose* pose) {
  using Vec3f = Eigen::Vector3f;
  using Mat3x3f = Eigen::Matrix3f;
  using Orientationf = Eigen::Quaternionf;
